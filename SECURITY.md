...
Do not open a public issue containing credentials, private pane output, command
history, unpublished repository content, or a working exploit against another
user's environment.
...
Maintainers aim to acknowledge a private report within seven calendar days. If
the form is unexpectedly unavailable, do not post sensitive details publicly;
open a minimal issue stating that private reporting is unavailable and wait for
a maintainer-provided private channel.

## Security boundaries

Herdr Orchestrator controls interactive coding-agent terminals. Changes can
affect:
...
If public disclosure may put users at risk, wait for a private response before
